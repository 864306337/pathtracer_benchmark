...
#ifndef ISPC____BENCHMARK_WRAPPER_H
#define ISPC____BENCHMARK_WRAPPER_H
...
#ifndef __ISPC_STRUCT_v16_varying_RTCRay__
#define __ISPC_STRUCT_v16_varying_RTCRay__
__ISPC_ALIGNED_STRUCT__(64) v16_varying_RTCRay {
    __ISPC_ALIGN__(64) float org_x[16];
    __ISPC_ALIGN__(64) float org_y[16];
    __ISPC_ALIGN__(64) float org_z[16];
    __ISPC_ALIGN__(64) float tnear[16];
    __ISPC_ALIGN__(64) float dir_x[16];
    __ISPC_ALIGN__(64) float dir_y[16];
    __ISPC_ALIGN__(64) float dir_z[16];
    __ISPC_ALIGN__(64) float time[16];
    __ISPC_ALIGN__(64) float tfar[16];
    __ISPC_ALIGN__(64) uint32_t mask[16];
    __ISPC_ALIGN__(64) uint32_t id[16];
    __ISPC_ALIGN__(64) uint32_t flags[16];
};
#endif

#ifndef __ISPC_STRUCT_v16_varying_RTCHit__
#define __ISPC_STRUCT_v16_varying_RTCHit__
__ISPC_ALIGNED_STRUCT__(64) v16_varying_RTCHit {
    __ISPC_ALIGN__(64) float Ng_x[16];
    __ISPC_ALIGN__(64) float Ng_y[16];
    __ISPC_ALIGN__(64) float Ng_z[16];
    ...
    __ISPC_ALIGN__(64) uint32_t instID[1][16];
};
#endif

#ifndef __ISPC_STRUCT_v16_varying_RTCRayHit__
#define __ISPC_STRUCT_v16_varying_RTCRayHit__
struct v16_varying_RTCRayHit {
    struct v16_varying_RTCRay ray;
    struct v16_varying_RTCHit hit;
};
#endif
...
extern "C" {
#endif // __cplusplus
    extern void benchmark_wrapper(struct RTCSceneTy * scene, struct RTCIntersectContext * context, struct v16_varying_RTCRayHit * rayhit);
#if defined(__cplusplus) && (! defined(__ISPC_NO_EXTERN_C) || !__ISPC_NO_EXTERN_C )
} /* end extern C */
#endif // __cplusplus
...
#endif // ISPC____BENCHMARK_WRAPPER_H
